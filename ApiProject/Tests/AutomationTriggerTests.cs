...
/*
 POST does not work -> Maybe is the body
TC_US_731425_Verify endpoint cannot be reached with invalid token -> 500 instead 401
Need help with bad request class
 */

namespace ApiFramework.Tests
{
    public class AutomationTriggerTests : BaseTest
    {
